...
/// Dadas duas listas lsta e lstb, defina uma função que verifique se lsta é prefixo de lstb,
/// isto é, se lstb começa com lsta.
pub fn prefixo(lsta: List(a), lstb: List(a)) -> Bool {
     case lsta, lstb {
        [], [] -> True 
        [], _ -> True
        _, [] -> False
        [primeiroa, ..restoa] , [primeirob, ..restob] -> primeiroa == primeirob && prefixo(restoa, restob)
     }
} 
